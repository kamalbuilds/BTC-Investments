...
export default function CCTPTransfer() {
  ...
  const handleTransfer = async () => {
    ...
    try {
      ...
      const destinationAddressInBytes32 = ethers.utils.hexZeroPad(recipientAddress, 32)
      ...
      const messageBytesHash = ethers.utils.keccak256(messageBytes)
  ...
  return (
    <Card className="w-[350px]">
      <CardHeader>
        ...
        <CardDescription>Transfer USDC across chains using Circle's CCTP</CardDescription>
      </CardHeader>
      <CardContent>
        <form>
